...
All analyses are implemented in Python using NumPy, SciPy, xarray, pandas and matplotlib; CMIP6 access uses \texttt{intake-esm} and \texttt{pangeo-cmip6}. The complete analysis code -- including the F$_{\mathrm{ovS}}$ decomposition kernel, statistical helpers and figure-rendering scripts -- is openly available; see the Data and Code Availability statement in the main text for the repository link.
