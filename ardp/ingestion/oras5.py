...
from ardp.ingestion.variable_maps import ORAS5, VarNames


class ORAS5Loader(ReanalysisLoader):
    """Loader for ECMWF ORAS5 reanalysis (NEMO ORCA025)."""
    ...
    def load_dataset(
        ...
        if self.mesh_mask_path and self.mesh_mask_path.exists():
            ...
            # Drop time from mesh mask if present
